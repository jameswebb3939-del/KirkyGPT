...
def main():
    parser = ArgumentParser(description="Run batch evaluation of follow-up question generation with TruLens.")
    parser.add_argument("--data_path", type=Path, required=True, help="Path to the evaluation dataset (JSONL format).")
    parser.add_argument("--output_dir", type=Path, required=True, help="Directory to save evaluation results.")
    parser.add_argument("--model_path", type=Path, default=None, help="Optional path to the model to evaluate.")
