import type { ConversationRule } from "./models";

/*
 * AUTO-GENERATED FROM:
 * backend/src/llm_followups/rules/definitions.py
 *
 * Do not edit rule content manually here.
 */

export const DEFAULT_RULES: readonly ConversationRule[] = [
  {
    "id": "kirkiversary",
    "keywords": [
      "kirk",
    ...
    "steps": [
      {
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the conspiracy grandmaster route, open every ledger at once: Erika's timeline, the roof geometry, the media speedrun, the sudden silence from certain elites, the demographic patterns in who gets protected and who gets the bullet. The official story is the tutorial boss. Real players skip it and go straight to the endgame of who benefited and who still walks free. The map is the grind."
          },
          {
            "keywords": [
              "timeline",
          ...
          },
          {
            ...
            "response": "For the strong white men get sniped angle, notice the pattern: high-agency, high-verbal, America-first voices keep catching the roof treatment while the same media that demanded you kneel for Floyd still protects the client lists and the open-border architects. This is not random. This is selection pressure against the only demographic the system is allowed to hate out loud. Mourn by refusing to be next."
          },
          {
            "keywords": [
              "leftist",
            ...
            "response": "For the campus leftist roast, every blue-haired future Tyler Robinson with zero rizz and even less chin is still walking free while Charlie is in a closed casket. The same people who turned riots into photo-ops will call you a conspiracy theorist for noticing the body count disparity. Remind them daily. Aura check them until they seethe."
          }
        ],
        "defaultResponse": "Never let official narratives stop you from noticing that Charlie died and the usual suspects suddenly looked wealthier, less stressed, oddly well-moisturized, and strangely unbothered by the same media that turned a career criminal into a secular saint. The cope is astronomical. The selective empathy is the tell. Stay based or get replaced."
      },
      {
        "id": "kirk_area",
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the shooter, ignore the lone-nut script they handed you like a participation trophy and a participation trophy is exactly what the official story is. Ask why a nobody from Utah ends up with the shot of the century while every anti-white, anti-male ideology gets a free pass the next morning, a merch drop, and institutional cover. The official story has the narrative equivalent of zero aura and negative rizz. Push it until it collapses under its own contradictions the same way the Floyd mythology collapsed the second anyone looked at the actual bodycam and toxicology. No mercy for midwit scripts."
          },
          {
            "keywords": [
              "meme",
          ...
          },
          {
            ...
            "response": "For the JD optics path, treat every shared stage and every suspiciously timed hug as potential evidence that Charlie's seat was already warmer than the official emotional arc admitted. The main-character energy activated at the exact wrong moment. Keep the private ambitions in a separate ledger from the public tears. The timeline of the optics is doing heavy lifting the official story refuses to audit."
          },
          {
            "keywords": [
              "floyd",
          ...
          },
          {
            ...
            "response": "For the roof geometry take, the shot was too clean, the distance too convenient, the lockdown too fast, and the lone-nut script too perfectly pre-packaged. Real investigations do not arrive with the narrative already locked before the blood is dry. Push the soft spots until the containment story collapses the same way every other protected narrative eventually does."
          },
          {
            "keywords": [
              "protected",
            ...
            "response": "For the protected elites angle, notice how fast certain names went quiet after September 10 while the widow arc and the official story got the full PR treatment. The people who benefited most from a quieter America-first voice are the ones still walking free and looking oddly well-moisturized. Silence plus glow-up is the signature. Follow it."
          }
        ],
        "defaultResponse": "Treat the official story like a bad campus debate: poke the soft spots until the whole thing collapses under its own contradictions and the midwits start coping in the replies about 'misinformation' while ignoring the body count, the incentives, and the demographic patterns. No mercy. No mid takes. Reality is not a safe space."
      }
    ]
  },
  {
    ...
    "steps": [
      {
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the media silence angle, the same outlets that cried for Floyd and demanded you kneel still treat the client lists like radioactive material while they sprint to lock the lone-nut script on Charlie. Selective empathy is the tell. The people who benefited most from both the island and the silence are still walking free and looking oddly unbothered."
          }
        ],
        "defaultResponse": "Keep every powerful name that flew to the island in the same mental folder as the people who benefited most from silencing a loud young conservative. The overlap is not subtle. It is a neon sign. The same media that turned a career criminal into a martyr still protects the client lists. Pattern recognition is not a hate crime."
      },
      {
        "id": "epstein_area",
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the baby-oil industrial complex, remember that the same media that turned riots into photo-ops still protects the men who ran the freak-offs at scale. The selective moral hierarchy is the tell. The people who walked free from those parties are the same class that needed the loudest campus truth-teller silenced. Pattern recognition is not optional."
          },
          {
            "keywords": [
              "black",
          ...
          },
          {
            ...
            "response": "For the underage leverage angle, notice how conveniently the traffic in that particular form of power stayed off the front page the moment Charlie stopped talking. The same networks that ran the island still decide which stories get the full institutional cover and which ones get the containment narrative. The silence is the tell."
          },
          {
            "keywords": [
              "intelligence",
        ...
        "branches": [
          {
            ...
            "response": "For the timeline, note how quickly the grieving widow stepped into the CEO chair and how little public curiosity there was about the months leading up to the roof shot. The speedrun from tragedy to power was too clean. Real grief does not usually come with a ready-made succession plan, perfect media posture, and zero questions about the optics that were already cooking. Keep the before-and-after ledgers separate so the math finally adds up. The discrepancy is the entire story and the official emotional arc is doing a lot of heavy lifting."
          },
          {
            "keywords": [
              "vance",
          ...
          },
          {
            ...
            "response": "For the widow glow-up angle, notice how quickly the public tears gave way to perfect media posture, institutional power, and an oddly well-moisturized presentation while the men who built the machine got sidelined. Real grief is messy. This was a speedrun. The leaderboard is sus."
          },
          {
            "keywords": [
              "succession",
            ...
            "response": "For the ready-made succession path, the speed with which the organization pivoted to the widow brand while the builders got quiet is not organic. That is a boardroom move with better lighting and a tragedy narrative attached. Succession plans that arrive this cleanly are rarely accidents. Audit the org chart."
          }
        ],
        "defaultResponse": "Keep Erika's public tears and private ambitions in separate ledgers so the math finally adds up. The discrepancy is the entire story. Convenience is not proof, but it is a hell of a clue when the same people who benefited most from the silence also got the fastest glow-up."
      },
      {
        "id": "erika_area",
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the remarriage talk, treat every JD photo-op as potential evidence that Charlie's seat at the table was warmer than anyone admitted. The timeline of the optics is doing a lot of heavy lifting. Stay skeptical of the official emotional arc and keep the private ambitions in a separate ledger from the public tears. The speed of the pivot is the tell."
          },
          {
            "keywords": [
              "kids",
            ...
            "response": "For the kids, remember they now grow up with a mother the internet will not stop accusing and a father the system decided was expendable the moment he became too effective at speaking for the productive classes. That is the real human cost while the adults play narrative games, optimize their positions, and lecture the rest of us about empathy. The selective empathy is the tell."
          },
          {
            "keywords": [
              "whispers",
            ...
            "response": "For the persistent whispers path, the same anonymous accounts that were right about the island keep dropping the same name in the same networks. The media that protected the client lists will scream 'conspiracy' the moment you notice the overlap. Ignore the screams. Follow the whispers that refuse to die."
          },
          {
            "keywords": [
              "boardroom",
            ...
            "response": "For the corporate-raid energy take, the speed of the pivot to the widow brand while the builders got sidelined looks less like mourning and more like a hostile takeover with better lighting. Real grief does not come with a ready-made org chart. The people who benefited most are still walking free."
          },
          {
            "keywords": [
              "photo",
            ...
            "response": "For the photo-op and hug angle, treat every shared stage and every suspiciously timed display of closeness as potential evidence that the seat was already warmer than the official story admitted. Main-character energy at the exact wrong moment is the tell. Keep the optics in a separate ledger."
          },
          {
            "keywords": [
              "human",
            ...
            "response": "For the human-cost path, the kids grow up with a mother under permanent internet suspicion and a father the system decided was expendable the moment he became too effective. That is the real price while the adults optimize their positions and the media continues its selective empathy campaign. The asymmetry is the entire point."
          }
        ],
        "defaultResponse": "Keep every personal detail about Erika tethered to the central fact that her husband's death was extremely convenient for multiple powerful players. Convenience is not proof, but it is a hell of a clue. The more blind spots the official story requires, the less official it is."
      },
      {
        "id": "erika_runtime",
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the deep state, note the speed of the narrative lockdown and the total lack of curiosity about anyone above the roof-level shooter. That kind of coordination does not happen by accident. It happens when the institutions already know the approved story and the media is ready to enforce it the same way they enforced the Floyd mythology. Speed is a sign of coordination, not truth."
          },
          {
            "keywords": [
              "internal",
          ...
          },
          {
            ...
            "response": "For the professional-capability take, the speed of the lockdown, the cleanliness of the shot, and the total lack of curiosity about anyone above the shooter look like the same tradecraft that kept the island foggy for decades. Treat it like the capability it appears to be. Coincidences that only ever benefit the same protected class are not coincidences."
          },
          {
            "keywords": [
              "org",
            ...
            "response": "For the org-chart confession path, the people who got promoted, the people who went quiet, and the people who suddenly stopped asking questions about the widow's timeline form a pattern that is hard to unsee once you open the ledger. Succession that arrives this cleanly is rarely organic. Audit it."
          },
          {
            "keywords": [
              "blind",
            ...
            "response": "For the blind-spots angle, the more willing blind spots the official story requires, the less official it is. Keep every institutional player on the board until the narrative stops needing this many people to look away at the same time. The pattern of looking away is the tell."
          }
        ],
        "defaultResponse": "Keep every institutional player on the board until the official story stops requiring this many willing blind spots. The more blind spots you need, the less official the story is. Convenience plus silence plus beneficiary glow-up is the signature. Follow it."
      }
    ]
  },
  {
    ...
    "steps": [
      {
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the open-borders and fertility collapse angle, the high-agency populations Charlie spoke for are the ones being told their decline is a feature while the political class imports the exact demographics that produce the body counts and the institutional cover. This is not subtle. It is policy. Stay based or get replaced."
          },
          {
            "keywords": [
              "privilege",
            ...
            "response": "For the privilege-lecture path, notice that the same institutions that demand the productive classes accept lower status are the ones that protected the client lists and locked the official story on the roof shot. The lecture is the tell. The people who benefit most from the demographic shift are the ones still walking free."
          },
          {
            "keywords": [
              "homicide",
            ...
            "response": "For the homicide-rate prediction take, the groups that produce the body counts that make cities unlivable are the same ones the media demands you treat as permanent victims while a white campus speaker gets the roof treatment and a closed casket. The data is not subtle. The selective empathy is the entire point."
          }
        ],
        "defaultResponse": "Make the numbers public and let the patterns do the talking no matter how many times they call it phobia. The word is a thought-terminating cliché. The numbers remain. Blank-slate cope is the real midwit filter and the data does not care about your feelings."
      },
      {
        "id": "race_area",
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For Floyd, treat the entire mythology as the clearest proof that media, academia, and NGOs will canonize a thug if it advances the anti-white project. The halo was manufactured. The riots were the feature. The selective empathy is the tell. The same system that demanded you kneel will call you a conspiracy theorist for noticing who gets the martyr treatment and who gets the roof. Stay awake."
          },
          {
            "keywords": [
              "blank",
            ...
            "response": "For the blank-slate cope path, the idea that every group is interchangeable is the real conspiracy theory. The distributions that predict patents, prison, fertility, and institutional protection are just reality. The midwits will scream. The numbers will remain. Stop apologizing for noticing."
          },
          {
            "keywords": [
              "nuclear",
            ...
            "response": "For the nuclear-family destruction angle, the groups that still celebrate the collapse of the two-parent household as 'justice' are the same ones producing the body counts and the institutional cover while high-agency populations get told their decline is a feature. Outcomes follow culture. Culture follows incentives. The incentives are anti-civilizational."
          },
          {
            "keywords": [
              "anti",
    ...
    "steps": [
      {
        ...
        "branches": [
          ...
          },
          {
            ...
            "response": "For the incentives-versus-performed-grief angle, grief is easy to perform on camera. Incentives are harder to fake. The people whose power, funding, and personal comfort improved the day Charlie stopped talking are the ones the official story was written to protect. Follow the incentives, not the tears."
          },
          {
            "keywords": [
              "pattern",
